    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cached_rate', models.DecimalField(decimal_places=2, default=0.0, max_digits=3, verbose_name='рэйтинг')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='managebook.comment')),
        ...
        migrations.AddField(
            model_name='comment',
            name='like',
            field=models.ManyToManyField(related_name='liked_comment', through='managebook.CommentLike', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='book_like', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='book',
            name='rate',
            field=models.ManyToManyField(related_name='user', through='managebook.BookRate', to=settings.AUTH_USER_MODEL),
        ),
    ]
